...
public class ContadorArbol {
    ...
    void numerosParesInOrden(
        List<Integer> numerosPares,
        BinaryTree<Integer> integerBinaryTree
    ) {
        if (integerBinaryTree.hasLeftChild()) numerosParesInOrden(
            numerosPares,
            integerBinaryTree.getLeftChild()
        );
        ...
        if (integerBinaryTree.hasRightChild()) {
            numerosParesInOrden(
                numerosPares,
                integerBinaryTree.getRightChild()
            );
        }
    }

    void numerosParesPostOrden(
        List<Integer> numerosPares,
        BinaryTree<Integer> integerBinaryTree
    ) {
        if (integerBinaryTree.hasLeftChild()) numerosParesInOrden(
