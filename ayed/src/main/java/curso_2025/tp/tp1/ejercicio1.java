...
public class ejercicio1 {
    /*
        ...
        int) a y b e impriman todos los números enteros comprendidos entre a y b (inclusive), uno por
        ...
        con valores de ejemplo. En su computadora, ejecute el programa y verifique
        que se cumple con lo pedido.
     */

    public static void bucleFor(int a, int b) {
        for (int i = a; i <= b; i++)
            System.out.println(i);
    }

    public static void bucleWhile(int a, int b){
        int i = a;
        while (i <= b) {
            System.out.println(i);
            i++;
    ...
    public static void bucleRecursivo(int a, int b){
        if (a <= b) {
